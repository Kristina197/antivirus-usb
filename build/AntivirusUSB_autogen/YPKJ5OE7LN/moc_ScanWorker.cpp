...
Q_CONSTINIT static const qt_meta_stringdata_ScanWorker_t qt_meta_stringdata_ScanWorker = {
    {
        ...
        QT_MOC_LITERAL(57, 10),  // "totalFiles"
        QT_MOC_LITERAL(68, 6)   // "doScan"
    },
    "ScanWorker",
    "scanFinished",
    "",
...
void ScanWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->scanFinished((*reinterpret_cast< std::add_pointer_t<std::vector<ScanResult>>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<int>>(_a[2]))); break;
        ...
        {
            using _t = void (ScanWorker::*)(const std::vector<ScanResult> & , int );
...
// SIGNAL 0
void ScanWorker::scanFinished(const std::vector<ScanResult> & _t1, int _t2)
{
