...
public:
    ...
    static void showInfectedResult(QWidget *parent, int threatsFound, int totalFiles) {
        ...
        dialog.setWindowTitle("Результаты сканирования");
        ...
        titleLabel->setStyleSheet("font-size: 28pt; font-weight: bold; color: #e74c3c; margin: 10px 0;");
        ...
        QLabel *threatsLabel = new QLabel(threatsText, &dialog);
        ...
        okButton->setStyleSheet(
            ...
            "border-radius: 8px; font-size: 16pt; font-weight: bold; padding: 10px; } "
    ...
    static void showCleanResult(QWidget *parent, int totalFiles) {
        ...
        titleLabel->setStyleSheet("font-size: 28pt; font-weight: bold; color: #27ae60; margin: 10px 0;");
        titleLabel->setAlignment(Qt::AlignCenter);
        layout->addWidget(titleLabel);
        
        QLabel *infoLabel = new QLabel("Угрозы не обнаружены", &dialog);
